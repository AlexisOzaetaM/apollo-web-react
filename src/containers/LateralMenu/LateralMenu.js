...
const LateralMenu = props => (
    <div className="lateral-menu-wrapper">
        <div className="lateral-menu-header-wrapper">
            <header className="lateral-menu-header">
                <ToggleButton clicked={props.collapseLateralMenuHandler} />
                <Link to="/app/home"><Logo/></Link>
            </header>
        </div>
        <Separator />
        <div className="lateral-menu-body-wrapper">
            <div className="lateral-menu-nav">
                <Link to="/app/home" className="nav-item-home">
                ...
                <Link to="/app/my-projects" className="nav-item-my-projects">
