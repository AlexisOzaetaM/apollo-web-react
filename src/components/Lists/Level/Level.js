...
const level = (props) => {
    let deleteButton = props.isDefault
        ? null
        : <div className="level-delete" onClick={props.onDelete}>
    ...
    let editButton = props.isDefault
        ? null
        : <div className="level-edit" onClick={props.onEdit}>
